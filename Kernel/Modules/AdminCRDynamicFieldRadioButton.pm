# --
# Kernel/Modules/AdminCRDynamicFieldRadioButton.pm - provides a dynamic fields radio button config view for admins
...
# This file was inspired in otrs AdminDynamicFieldDropdown.pm,v 1.12
#
# otrs is Copyright (C) 2001-2011 OTRS AG, http://otrs.org/
# --

package Kernel::Modules::AdminCRDynamicFieldRadioButton;
...
sub _AddAction {
    ...
    for my $ConfigParam (
        ...
        TranslatableValues ValidID Link Columns
        )
        )
    {
...
sub _Change {
    ...
    if ( IsHashRefWithData( $DynamicFieldData->{Config} ) ) {
        ...
        # set Columns
        $Config{Columns} = $DynamicFieldData->{Config}->{Columns};
    }
...
sub _ShowScreen {
    ...
    $Output .= $Self->{LayoutObject}->Output(
        TemplateFile => 'AdminCRDynamicFieldRadioButton',
        Data         => {
            %Param,
